...
class ProductdetailView extends StatefulWidget {
  ProductdetailView(
      {super.key, required this.productData, this.isBannerInput = false});
...
class _ProductdetailViewState extends State<ProductdetailView> {
  ...
  Widget build(BuildContext context) {
    ProductModel productData = widget.productData;

    log(productData.toJson().toString());
              ...
              Column(
                ...
                children: [
                  ...
                  (productData.relatedBundleItems!.isEmpty ||
                          productData.relatedBundleItems == null)
                      ? const SizedBox()
                      : Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
